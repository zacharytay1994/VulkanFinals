...
namespace VK_OBJECT
{
	Swapchain::Swapchain ( VkPhysicalDevice vkPhysicalDevice , VkDevice vkLogicalDevice , VkSurfaceKHR vkSurface )
		:
	...
	VkExtent2D Swapchain::GetExtent2D ( VkPhysicalDevice vkPhysicalDevice , VkSurfaceKHR vkSurface )
	{
		...
		{
			VkExtent2D actual_extent = { static_cast< uint32_t >( WND_HELPER::g_width ), static_cast< uint32_t >( WND_HELPER::g_height ) };
